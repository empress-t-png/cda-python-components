...
Perfect! You're now editing the README.md file on the labmodule04 branch!

This is the main repository README. You need to **scroll down** to add your Lab Module 04 section.

## Here's what to do:

**Scroll down to the bottom of the file**, then add this section:
...
![Lab Module 04 UML Class Diagram](./uml/lab04-class-diagram.png)
